...
function StoreShirts:init()
    ...
    sprite("Dropbox:reactor7")
    moveToStoreButton2 = Button("Dropbox:Blue Back Circle Button", vec2(WIDTH/2-300, HEIGHT/2+420))
    shirtOne = Button("Dropbox:reactor", vec2(WIDTH/2+300, HEIGHT/2))
    shirtTwo = Button("Dropbox:reactor2", vec2(WIDTH/2+300, HEIGHT/2-120))
    shirtThree = Button("Dropbox:reactor3", vec2(WIDTH/2+300, HEIGHT/2-240))
    shirtFour = Button("Dropbox:reactor4", vec2(WIDTH/2, HEIGHT/2-120))
    shirtFive = Button("Dropbox:reactor5", vec2(WIDTH/2-300, HEIGHT/2-240))
    shirtSix = Button("Dropbox:reactor6", vec2(WIDTH/2-300, HEIGHT/2))
    shirtSeven = Button("Dropbox:reactor7", vec2(WIDTH/2-300, HEIGHT/2-120))
